...
const scenes = [
  ...
  },
  {
    ...
    edges: [
      ...
      edge('to-queue', 'request', 'queue', [[540, 355], [540, 395], [410, 395], [410, 415]], 'WAIT', [475, 375]),
      edge('to-degrade', 'request', 'degrade', [[610, 355], [610, 395], [750, 395], [750, 415]], 'FALLBACK', [680, 375]),
      edge('to-reject', 'request', 'reject', [[660, 335], [660, 375], [1010, 375], [1010, 415]], 'OVERLOAD', [850, 355], 'reject'),
    ],
  ...
  },
  {
    ...
    edges: [
      ...
      edge('cancel', 'queued', 'cancelled', [[345, 185], [345, 160], [1120, 160], [1120, 441], [1090, 441]], 'cancel intent', [1050, 330], 'terminal'),
    ],
  ...
  },
  {
    ...
    edges: [
      ...
      edge('ready-trace', 'ready', 'trace', [[405, 249], [405, 410]], 'requestId', [470, 330]),
      edge('ready-metric', 'ready', 'metric', [[445, 249], [445, 350], [695, 350], [695, 410]], 'bounded', [570, 332]),
      edge('ready-eval', 'ready', 'eval', [[485, 185], [485, 155], [1120, 155], [1120, 390], [965, 390], [965, 410]], 'quality', [1090, 330]),
    ],
