...
const scenes = [
  ...
  graphScene(
    ...
    [
      ...
      edge('termination-done', 'termination', 'done', [[990, 308], [990, 365], [795, 365], [795, 410]], 'TRUE', [875, 365]),
      edge('termination-blocked', 'termination', 'blocked', [[990, 308], [990, 410]], 'UNKNOWN', [1060, 360]),
    ],
  ),
  graphScene(
  ...
  graphScene(
    ...
    [
      ...
      edge('guard-stop', 'guard', 'stop', [[170, 312], [170, 350], [370, 350], [370, 430]], 'DONE', [270, 350]),
      edge('guard-blocked', 'guard', 'blocked', [[170, 312], [170, 330], [590, 330], [590, 430]], 'NO PRECONDITION', [470, 330]),
      edge('guard-budget', 'guard', 'budget', [[60, 266], [20, 266], [20, 550], [830, 550], [830, 502]], 'LIMIT HIT', [620, 550]),
      edge(
        'continue-guard',
        'continue',
        'guard',
        [[60, 466], [35, 466], [35, 266], [60, 266]],
        undefined,
        undefined,
        'feedback',
      ),
  ...
  graphScene(
    ...
    [
      edge('task-direct', 'task', 'direct', [[250, 314], [285, 314], [285, 214], [330, 214]], 'STABLE', [285, 235]),
      edge('task-plan', 'task', 'plan', [[250, 314], [285, 314], [285, 414], [330, 414]], 'KNOWN', [290, 390]),
      edge('direct-verified', 'direct', 'verified', [[425, 170], [425, 155], [900, 155], [900, 314], [950, 314]], 'ONE STEP', [710, 155]),
      edge('plan-replan', 'plan', 'replan', [[540, 414], [600, 414], [600, 214], [650, 214]], 'NEW FACTS', [600, 315]),
      edge('plan-graph', 'plan', 'graph', [[540, 414], [650, 414]], 'DURABLE', [595, 465]),
      edge('replan-verified', 'replan', 'verified', [[840, 214], [900, 214], [900, 314], [950, 314]]),
      edge('graph-verified', 'graph', 'verified', [[860, 414], [900, 414], [900, 314], [950, 314]]),
    ],
  ),
  graphScene(
    ...
    [
      edge('decompose-a', 'decompose', 'branch-a', [[250, 314], [300, 314], [300, 214], [350, 214]], '2 PARALLEL BRANCHES', [390, 140]),
      edge('decompose-b', 'decompose', 'branch-b', [[250, 314], [300, 314], [300, 414], [350, 414]]),
      edge('a-join', 'branch-a', 'join', [[550, 214], [620, 214], [620, 314], [690, 314]], 'JOIN INPUT 1', [620, 190]),
      edge('b-join', 'branch-b', 'join', [[550, 414], [620, 414], [620, 314], [690, 314]], 'JOIN INPUT 2', [620, 440]),
  ...
  graphScene(
    ...
    [
      ...
      edge('validate-accept', 'validate', 'accept', [[1015, 348], [1015, 395], [885, 395], [885, 440]], 'PROVED', [930, 395]),
      edge('validate-reject', 'validate', 'reject', [[1015, 348], [1015, 440]], 'NOT PROVED', [1090, 395]),
    ],
  ),
  graphScene(
    ...
    [
      ...
      edge('reconcile-resume', 'reconcile', 'resume', [[830, 304], [875, 304], [875, 209], [930, 209]], 'KNOWN', [875, 245]),
      edge('reconcile-blocked', 'reconcile', 'blocked', [[830, 304], [880, 304], [880, 329], [930, 329]], 'UNKNOWN', [880, 355]),
  ...
  graphScene(
    ...
    [
      ...
      edge(
        ...
        'validator',
        'loop',
        [[870, 284], [840, 284], [840, 390], [435, 390], [435, 328]],
        'CONTINUE',
        [640, 390],
        'feedback',
      ),
