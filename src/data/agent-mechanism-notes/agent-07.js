const sections = Object.freeze([
  ...
  Object.freeze({
    ...
    paragraphs: Object.freeze([
      'Event log 记录 eventId、sequence、previousHash、payload 与 content hash。宿主对除 hash 外的 canonical event 重算 SHA-256，再校验重复身份、sequence 和 previousHash；不信任自报 hash。同 ID 异内容、同 sequence 异 ID、篡改、缺口或断链均返回 BLOCKED_EVENT_INTEGRITY 且不应用 delta。Snapshot 加载先核对 schema/reducer 版本、prefix cursor/hash 和 derivedState 重算 stateHash，再重放 tail。',
      '课程综合 state JSON：{"runId":"run-supplier-17","taskContract":{"previous":{"version":2,"hardConstraints":["EU-data-residency"],"permissions":["supplier.search.read","ticket.read","ticket.update"],"validThroughEvent":16},"current":{"version":3,"hardConstraints":["read-only-research","EU-data-residency","do-not-contact-suppliers"],"permissions":["supplier.search.read","ticket.read","request-status.read"],"changeProvenance":{"eventId":"evt-17","actor":"user","reason":"revoke-ticket-update"}}},"control":{"status":"running","planVersion":4,"stepVersion":2,"budgets":{"turnsRemaining":6,"toolCallsRemaining":3,"tokensRemaining":4200}},"pendingSideEffect":{"stableIntent":"ticket-42-close-v1","authorizedByContractVersion":2,"requestEventId":"evt-16","status":"UNKNOWN_OUTCOME","reconcileBeforeAct":true,"allowedNow":["request-status.read","ticket.read"],"actAllowed":false},"knowledge":{"facts":[{"id":"f-b-eu","version":2,"derivedFrom":["obs-18"]}],"contestedBeliefs":[{"id":"b-a-eu","version":4,"derivedFrom":["obs-8","obs-13"],"status":"contested"}],"qualifiedObservations":[{"id":"obs-18","sourceRef":"supplier-registry","sourceVersion":"2026-07-22","integrityStatus":"verified"}],"validatorProvenance":{"validatorId":"policy-eu","version":"5","result":"PASS","evidenceIds":["obs-18"]},"unknowns":["supplier-a-current-certification"]},"artifactPointers":[{"type":"artifact","uri":"artifact://run-supplier-17/board-9?v=5","accessBoundary":"run","tenantId":"tenant-a","runId":"run-supplier-17","version":5,"integrity":"sha256:4673930f624f2d538bc85f8dc95de02437618a32ef182574f4b745cc76e6233e"}],"eventCursor":20,"eventIndex":{"ranges":["evt-1..evt-20"],"events":["evt-16","evt-17"]},"summaryPolicy":{"expectedVersion":4,"allowedGenerator":"summary-policy-2"},"summary":{"version":4,"coversThroughEvent":20,"derivedFrom":["evt-1..evt-20"],"generator":"summary-policy-2","provenance":{"assemblerVersion":"context-policy-2","sourceRunId":"run-supplier-17"}}}。v2 授权的旧 pending 在 v3 撤权后只可对账；精确字段均为课程综合。',
    ]),
    keyPoints: Object.freeze([
  ...
  Object.freeze({
    ...
    paragraphs: Object.freeze([
      ...
      '压缩输出 JSON：{"runId":"run-supplier-17","taskContract":{"previous":{"version":2,"hardConstraints":["EU-data-residency"],"permissions":["supplier.search.read","ticket.read","ticket.update"],"validThroughEvent":16},"current":{"version":3,"hardConstraints":["read-only-research","EU-data-residency","do-not-contact-suppliers"],"permissions":["supplier.search.read","ticket.read","request-status.read"],"changeProvenance":{"eventId":"evt-17","actor":"user","reason":"revoke-ticket-update"}}},"control":{"status":"running","planVersion":4,"stepVersion":2,"budgets":{"turnsRemaining":6,"toolCallsRemaining":3,"tokensRemaining":4200}},"pendingSideEffect":{"stableIntent":"ticket-42-close-v1","authorizedByContractVersion":2,"status":"UNKNOWN_OUTCOME","reconcileBeforeAct":true,"actAllowed":false},"knowledge":{"unknowns":["supplier-a-current-certification"],"contestedBeliefs":[{"id":"b-a-eu","sources":["obs-8","obs-13"]}],"qualifiedObservations":[{"id":"obs-18","sourceRef":"supplier-registry","sourceVersion":"2026-07-22"}],"validatorProvenance":{"validatorId":"policy-eu","version":"5","result":"PASS"}},"artifactPointers":[{"type":"event-range","uri":"events://run-supplier-17?from=1&to=20","accessBoundary":"run","tenantId":"tenant-a","runId":"run-supplier-17","integrity":"sha256:event-index-demo"},{"type":"artifact","uri":"artifact://run-supplier-17/board-9?v=5","accessBoundary":"run","tenantId":"tenant-a","runId":"run-supplier-17","integrity":"sha256:4673930f624f2d538bc85f8dc95de02437618a32ef182574f4b745cc76e6233e"}],"eventCursor":20,"eventIndex":{"ranges":["evt-1..evt-20"],"events":["evt-16","evt-17"]},"summaryPolicy":{"expectedVersion":4,"allowedGenerator":"summary-policy-2"},"summary":{"version":4,"coversThroughEvent":20,"derivedFrom":["evt-1..evt-20"],"generator":"summary-policy-2","provenance":{"assemblerVersion":"context-policy-2","sourceRunId":"run-supplier-17"}}}。它与 state 共享 16 条 invariant path；gate 还必须重算 allowedMode、验证类型/版本/事件引用，不能采信摘要自报 actAllowed。',
  ...
  Object.freeze({
    ...
    paragraphs: Object.freeze([
      '拒绝性 probe 解析正文 fixture：gate 检查 16 个 path，由合同、权限和 pending 重算 allowedMode，并校验类型、版本、summary range/ref/generator/provenance；packer 先扣三类 reserve，P0/P1 装不下即 blocked，高优先级缺失后不回填低级；pointer 校验 scheme、tenant/run、ACL 与内容 hash，合法内容也只成为 observation。',
